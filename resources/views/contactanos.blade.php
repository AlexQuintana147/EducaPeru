...
<style>
    ...
    /* .info-card:hover { border-color: rgba(255,255,255,0.15); transform: translateY(-3px); } */
    .info-icon {
    ...
    .section-label {
        ...
        color: #a1a1aa; margin-bottom: 12px;
        display: flex; align-items: center; gap: 10px;
    }
    .section-label::before {
        content: ''; display: block;
        width: 28px; height: 2px;
        background: #a1a1aa; border-radius: 2px; flex-shrink: 0;
    }
    .section-title {
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                <div class="info-card">
                    ...
                    <div class="info-title">Dirección
                        <span>📍</span>
                    </div>
                ...
                <div class="info-card">
                    {{-- <div class="info-icon"></div> --}}
                    <div class="info-title">Email <span>📧</span></div>
                    <div class="info-desc">contacto@educaperu.com</div>
                </div>
                <div class="info-card">
                    {{-- <div class="info-icon"></div> --}}
                    <div class="info-title">Teléfono <span>📞</span></div>
