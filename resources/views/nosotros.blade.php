  ...
  <section class="relative hero-full px-4 sm:px-10 border-b border-blueprint">
    <div class="max-w-5xl mx-auto text-center relative z-10">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mb-8 sm:mb-16 hero-buttons-container">
        <a href="#valores" class="w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 bg-white text-black font-display font-bold text-xs sm:text-sm uppercase tracking-widest btn-glow text-center">
          Nuestros valores
        </a>
        <a href="/capacitaciones" class="w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 border border-blueprint text-white font-display font-bold text-xs sm:text-sm uppercase tracking-widest hover:bg-white/5 transition-all text-center">
          Ver cursos
        </a>
      </div>
      <div class="flex flex-row items-center justify-center gap-2 sm:gap-8 text-white/20">
        <div class="flex items-center gap-1.5 sm:gap-3">
          <i class="ti ti-award text-xl sm:text-2xl text-white"></i>
          <div class="text-left">
            <div class="text-[10px] sm:text-[11px] font-bold text-white/50 uppercase tracking-wider">Excelencia</div>
            <div class="text-[9px] sm:text-[10px] text-white/25">Académica</div>
          </div>
        </div>
        <div class="w-px h-8 sm:h-10 bg-white/10"></div>
        <div class="flex items-center gap-1.5 sm:gap-3">
          <i class="ti ti-bulb text-xl sm:text-2xl text-white"></i>
          <div class="text-left">
            <div class="text-[10px] sm:text-[11px] font-bold text-white/50 uppercase tracking-wider">Innovación</div>
            <div class="text-[9px] sm:text-[10px] text-white/25">Metodológica</div>
          </div>
        </div>
        <div class="w-px h-8 sm:h-10 bg-white/10"></div>
        <div class="flex items-center gap-1.5 sm:gap-3">
          <i class="ti ti-heart-handshake text-xl sm:text-2xl text-white"></i>
          <div class="text-left">
            <div class="text-[10px] sm:text-[11px] font-bold text-white/50 uppercase tracking-wider">Compromiso</div>
            <div class="text-[9px] sm:text-[10px] text-white/25">Permanente</div>
          </div>
        </div>
      </div>
    </div>
